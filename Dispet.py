...
from Threads import CPUInfo, RamInfo, DisksInfo, UpdateGraf, ProcessesInfo, SlujbaInfo
...
class Window(QtWidgets.QMainWindow):
    ...
    def CPUGraph(self): #fixme попытаться перенести в триды
        """
